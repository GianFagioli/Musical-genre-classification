...
for i=1 : 11
    ...
    [clasico(i,:)] = partes_senial (s_clasico, fm_clasico(i,1));
...
for i=1 : 11
    ...
    [cumbia(i,:)] = partes_senial (s_cumbia, fm_cumbia(i,1));
...
for i=1 : 12
    ...
    [folklore(i,:)] = partes_senial (s_folklore, fm_folklore(i,1));
...
for i=1 : 12
    ...
    [rap(i,:)] = partes_senial (s_rap, fm_rap(i,1));
...
for i=1 : 11
    ...
    [reggae(i,:)] = partes_senial (s_reggae, fm_reggae(i,1));
...
for i=1 : 12
    ...
    [rock(i,:)] = partes_senial (s_rock, fm_rock(i,1));
